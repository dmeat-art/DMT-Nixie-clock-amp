...
<a href="https://github.com/dmeat-art/DMT-Nixie-clock-amp/blob/main/Concept-art/2017-01.png"><img src="https://github.com/dmeat-art/DMT-Nixie-clock-amp/blob/main/Images/Thumbs/2017-01.png"></a>
 <a href="https://github.com/dmeat-art/DMT-Nixie-clock-amp/blob/main/Concept-art/2017-02.png"><img src="https://github.com/dmeat-art/DMT-Nixie-clock-amp/blob/main/Images/Thumbs/2017-02.png"></a>
...
- If the button is pressed down when the clock is powered on, a wifi access point is created.
- You can connect to it without any password.
- You then go to the IP adress specified in the code, enter your local wifi SSID and password, click on submit.
- These infos are saved in the arduino's EEPROM.
- The clock will "reboot" and get into "get time" mode.

2. **"Get Time" mode :**

The clock "boots" :
- It starts the wifi client,
- Connects to your local wifi,
- Then to the NTP Server,
- Recovers the current time
- Disconnects
- And gets into Clock Mode.
